...
#
#Una característica de los programas con mÃºltiples funcionalidades es que ofrecen un menú de acciones
...
while abierto:
    ...
    print("2. Cambiar mi nombre")
    print("3. Cambiar mi edad")
    print("4. Salir")
    opcion = int(input("¿Que deseas hacer?(1/2/3/4)"))
    ...
    if opcion == 1:
        ...
        agno = int(input("Dime ¿En qué año naciste? "))
        edad = 2017 - agno - 1
        print("Edad:    ", edad, "años")
    elif opcion == 4:
        abierto = False
